        ...
        <div className="flex justify-center px-4 items-center min-h-screen bg-gray-100">
            <div className="w-full max-w-4xl -mt-12 pb-10 bg-white px-6 h-[450px] rounded-lg shadow-md overflow-y-auto relative">
                ...
                <div className="sticky py-5 top-0 z-10 bg-white">
                    <h2 className="text-2xl font-bold text-center mb-2">Interview Details</h2>
                    <table className="w-full table-auto">
                        <thead>
                            <tr>
                                <th className="px-4 py-2 text-left text-sm font-medium text-gray-700">Student</th>
                                <th className="px-4 py-2 text-center text-sm font-medium text-gray-700">Company Name</th>
                ...
                {students.length > 0 ? (
                    ...
                    <div className="text-center text-gray-500">Currently Not Fetching details.</div>
                )}
            </div>
        </div>
    );
